...
void make_hardcoded_template(Glib::RefPtr<Gtk::ListStore> treestore_templates,
                    const TemplateCols &template_cols, const std::string &name,
                    const std::string &vars_names, const std::string &tags,
